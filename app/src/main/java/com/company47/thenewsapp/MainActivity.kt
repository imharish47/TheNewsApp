package com.company47.thenewsapp

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.fragment.app.Fragment
import com.company47.thenewsapp.databinding.ActivityMainBinding
import com.company47.thenewsapp.features.bookmarks.BookmarksFragment
import com.company47.thenewsapp.features.breakingnews.BreakingNewsFragment
import com.company47.thenewsapp.features.searchnews.SearchNewsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        if (selectedIndex != 0) {
            binding.bottomNavigationView.selectedItemId = R.id.nav_breaking
        } else {
            super.onBackPressed()
        }
    }
